...
//引入自定义函数 
import { countWorkYears, getLongestServingWorkers } from "../common/func/user/useWorkerStats";
const useUserStore = create()(
  immer((set, get) => ({
    ...
    getUsers: async () => {
      ...
      try {
        const response = await getUsers(res=> res.data);
    ...
    getUserStats: (targetYear: number) => {
      ...
      const tenWorkersLongest = getLongestServingWorkers(usersList, 10);
