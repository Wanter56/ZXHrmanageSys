...
const DashBoard: React.FC = () => {
  ...
  return (
    <div className="dashboard">
      ...
      <div style={{ display: "flex", flexDirection:"row",width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        <div style={{marginRight:"50px"}}>员工性别占比</div>
        <div>员工婚姻情况</div>
        <Echart style={{ height: "300px", width: "45%" }} charData={genderList} isAxisChart={false} />
        <Echart style={{ height: "300px", width: "45%" }} charData={marriageList} isAxisChart={false} />
      </div>
      <div style={{ display: "flex", width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        <Echart style={{ height: "300px", width: "45%" }} charData={educationList} isAxisChart={false} />
        <Echart style={{ height: "300px", width: "45%" }} charData={constellationList} isAxisChart={false} />
      </div>
      <div style={{ display: "flex", width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
