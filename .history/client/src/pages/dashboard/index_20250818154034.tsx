  ...
  return (
    <div className="dashboard">
      ...
      <div style={{ display: "flex",width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        <Echart style={{ height: "300px", width: "45%" }} charData={genderList} isAxisChart={false} charTitle={{text:"员工性别占比:",left:"center"}}/>
        <Echart style={{ height: "300px", width: "45%" }} charData={marriageList} isAxisChart={false} charTitle={{text:"员工婚姻情况:",left:"center"}} />
      </div>
      <div style={{ display: "flex", width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        <Echart style={{ height: "300px", width: "45%" }} charData={educationList} isAxisChart={false} charTitle={{text:"员工学历情况:",left:"center"}}/>
        <Echart style={{ height: "300px", width: "45%" }} charData={constellationList} isAxisChart={false} charTitle={{text:"员工星座情况:",left:"center"}}/>
      </div>
      <div style={{ display: "flex", width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        {ageMap && <Echart style={{ height: "300px", width: "45%" }} charData={ageMap} isAxisChart={true} charTitle={{text:"员工年龄情况:",left:"center"}}/>}
        {departmentList && (
          <Echart style={{ height: "300px", width: "45%" }} charData={departmentList} isAxisChart={true} charTitle={{text:"部门分布:",left:"center"}}/>
        )}
      </div>
