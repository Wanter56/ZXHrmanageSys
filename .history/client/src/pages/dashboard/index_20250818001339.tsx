  ...
  return (
    <div className="dashboard">
      ...
      <div style={{ display: "flex", width: "90%", border: "1px solid  ", margin: " 0 auto", marginTop: "30px" }}>
        <Echart style={{ height: "300px" }} charData={educationList} isAxisChart={false} />
        <Echart style={{ height: "300px" }} charData={genderList} isAxisChart={false} />
        <Echart style={{ height: "300px" }} charData={marriageList} isAxisChart={false} />
      </div>
