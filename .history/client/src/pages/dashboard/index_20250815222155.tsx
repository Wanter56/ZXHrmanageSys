...
const DashBoard: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    return { total, over10Years, over3Years, within1Year };
  ...
  return (
    <div className="dashboard">
      ...
      <Row gutter={16} className="year-card">
        <Col span={8}>
          <Card title="入职十年以上" variant="borderless">
            <div className="year-f">{stats.over10Years}人</div>
          </Card>
        </Col>
        <Col span={8}>
          <Card title="入职三年以上" variant="borderless">
            <div className="year-f">{stats.over3Years}人</div>
          </Card>
        </Col>
        <Col span={8}>
          <Card title="入职一年以内" variant="borderless">
            <div className="year-f">{stats.within1Year}人</div>
          </Card>
        </Col>
      </Row>
    </div>
