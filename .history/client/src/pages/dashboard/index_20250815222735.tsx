  ...
  return (
    <div className="dashboard">
      ...
      <Card title="Card Title">
        <Card.Grid style={{width:30%}}>入职十年以上:{stats.over10Years}人</Card.Grid>
        <Card.Grid style={gridStyle}>入职三年以上:{stats.over3Years}人</Card.Grid>
        <Card.Grid style={gridStyle}>入职一年以内:{stats.within1Year}人</Card.Grid>
      </Card>
    </div>
  );
};
